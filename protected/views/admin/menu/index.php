            ...
            "contextmenu":  { 'items': {
                    ...
                    "properties" : {
                        ...
                        "action" : function (obj) {
                            ...
                            $.ajax({
                                type:"POST",
                                url:"<?php echo Yii::app()->getBaseUrl(); ?>/menu/returnView",
                                data:   {
                                    "id" :id,
                                    "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken; ?>"
                                },
                        ...
                        "action" : function (obj) {
                            ...
                            jQuery("#<?php echo Menu::ADMIN_TREE_CONTAINER_ID; ?>").jstree("remove",obj);
                             ...
                             .bind("rename.jstree", function (e, data) {
                                 $.ajax({
                                     type:"POST",
                                     url:"<?php echo Yii::app()->getBaseUrl(); ?>/menu/rename",
                                     data:  {
                             ...
                             .bind("remove.jstree", function (e, data) {
                                 $.ajax({
                                     type:"POST",
                                     url:"<?php echo Yii::app()->getBaseUrl(); ?>/menu/remove",
                                     data:{
                                         "id" : data.rslt.obj.attr("id").replace("node_",""),
                                         "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken; ?>"
                                     },
                             ...
                             .bind("move_node.jstree", function (e, data) {
                                 data.rslt.o.each(function (i) {
                                     ...
                                     $.ajax({
                                         async : false,
                                         type: 'POST',
                                         url: "<?php echo Yii::app()->getBaseUrl(); ?>/menu/moveCopy",
